...
<header >
            ...
            <div className={`md:block ${isOpen ? 'h-screen  backdrop-blur-[10px]  bg-linear-gradient flex flex-col justify-center z-20' : 'h-0 border-b   border-blue/40 backdrop-blur-[10px] z-50'} fixed top-0 left-0 w-full  transition-height overflow-hidden md:h-auto`}>
                <Container>
